...
const NavHeader = () => {
	...
	const isCreatorHub = pathname.includes("/creator/");
		...
		<header className="flex items-center h-16 bg-white-800 text-black px-4  border-b-4 border-gray-500 sticky top-0 z-50 bg-white">
			<div className="flex items-center">
				<a href="/" className="block">
					<img src="logo.png" alt="CreatorHub Logo" className="h-8 w-auto fill-current" />
				</a>
				{/* <span className="ml-4 text-xl font-bold">CreatorHub</span> */}
			</div>
			{!isCreatorHub && (
				<nav className="flex">
