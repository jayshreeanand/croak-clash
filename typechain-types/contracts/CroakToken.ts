...
export interface CroakTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface CroakToken extends BaseContract {
  connect(runner?: ContractRunner | null): CroakToken;
  waitForDeployment(): Promise<this>;

  interface: CroakTokenInterface;
  ...
  stakedTokens: TypedContractMethod<[arg0: AddressLike], [bigint], "view">;
